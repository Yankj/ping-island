...
private let logger = Logger(subsystem: "com.agentisland.app", category: "Interrupt")
...
class JSONLInterruptWatcher {
    ...
    private let queue = DispatchQueue(label: "com.agentisland.app.interruptwatcher", qos: .userInteractive)
