...
private let logger = Logger(subsystem: "com.agentisland.app", category: "AgentFileWatcher")
...
class AgentFileWatcher {
    ...
    private let queue = DispatchQueue(label: "com.agentisland.app.agentfilewatcher", qos: .userInitiated)
