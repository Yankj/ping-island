...
- AgentIsland first-run ceremony, staged audio, explicit Hooks consent, surface-mode onboarding, icon pipeline, and shallow quit actions: `PingIsland/App/AppDelegate.swift`, `PingIsland/Core/AppSoundSynthesizer.swift`, `PingIsland/UI/Window/SettingsWindowController.swift`, `PingIsland/UI/Views/SettingsWindowView.swift`, `PingIsland/UI/Views/NotchView.swift`, `PingIsland/UI/Window/DetachedIslandWindowController.swift`, `PingIsland/Resources/Brand/`, `scripts/build-agent-island-icon.c`, `docs/agent-island-onboarding.md`
...
- If you change built-in notification sounds or startup audio, inspect `PingIsland/Core/Settings.swift`, `PingIsland/Core/AppSoundSynthesizer.swift`, `PingIsland/Core/SoundPackCatalog.swift`, `PingIsland/UI/Views/SettingsWindowView.swift`, `PingIsland/App/AppDelegate.swift`, and `PingIsland/Resources/Sounds/` together so mode selection, synth cues, playback prewarming, previews, and bundled assets stay aligned.
